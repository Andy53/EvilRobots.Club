...
<p align="center">![X64dbg with the ERC plugin running and the target application open.](/_images/basics-of-exploit-development-1-win32-buffer-overflows/image_1.jpeg)</p>    
_X64dbg with the ERC plugin running and the target application open._
...
_Illustration of a Win32 Stack Frame_
...
_EIP overwritten with As (0x41)_
...
_ERC -- compare displaying 0x00 did not transfer properly into memory_
...
_Input string parsed into memory without alterations_
...
_ERC –SearchMemory FF E4 -ASLR -SafeSEH -Rebase -NXCompat_
...
_Landing at our jmp esp instruction_
...
_Payload generation with MSFVenom_
